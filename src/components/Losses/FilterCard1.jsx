...
const FilterCard = () => {
  ...
  const handleSubmit = () => {
    ...
    // console.log(
    //   "Submit Filter card 1 ",
    //   localDateRange,
    //   localZone,
    //   localMachine
    // );

    dispatch(setCurrentMachine1(localMachine));
    dispatch(setCurrentZone1(localZone));
    dispatch(setDateRange1(localDateRange));
  };
        ...
        <FormControl style={{ marginRight: "16px", width: "15.5rem" }}>
          ...
          <Select
            ...
            sx={{
              ...
              "& .MuiSelect-icon": {
                color: `${colors.info.main} !important`, // Set the dropdown arrow color
              },
              fontFamily: fonts.fontStyle3["font-family"],
              fontStyle: fonts.fontStyle3["font-style"],
              fontWeight: fonts.fontStyle3["font-weight"],
