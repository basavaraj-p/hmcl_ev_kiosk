...
import { setShiftsBreaksHistory } from "../../redux/shiftsHistorySlice";
import {
  date_range_style,
  chip_style,
  form_control_header,
...
const SBHFilterCard = () => {
  ...
  const handleSubmit = async () => {
    ...
    // console.log("localZone : ", localZone);
    // console.log("localShift : ", localShift);
    const rowData = await getShiftHistory();
    // console.log("rowData : ", rowData);
    dispatch(setShiftsBreaksHistory(rowData));
  };
