...
const SBHTable = () => {
  ...
  const shiftsBreaksHistory = useSelector(
    (state) => state.shiftsHistory.shiftsBreaksHistory
  );
  // console.log("shiftsBreaksHistory : ", shiftsBreaksHistory);
  useEffect(() => {
    setTableData(shiftsBreaksHistory);
  }, [shiftsBreaksHistory]);
